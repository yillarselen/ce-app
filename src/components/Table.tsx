...
const Table = ({ data, colors }: TableProps) => {
  ...
  return (
    <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
      <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 dark:bg-slate-800">
        ...
        <tbody>
          {data?.map((item) => (
            <tr
              key={item.Id}
              className="even:bg-gray-50 odd:bg-white odd:dark:bg-gray-600 border-b even:dark:bg-gray-800 dark:border-gray-700"
            >
